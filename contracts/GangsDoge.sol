...
contract GangsDoge is ERC20, Ownable {
    ...
    constructor(IRouter router_, address marketing_) ERC20("GangsDoge", "GSDoge") {
        router = router_;
    ...
    function setTax(uint256 _buyTax, uint256 _sellTax) external onlyOwner {
        require(_buyTax <= 10 && _sellTax <= 10, "too high");
        buyTax = _buyTax;
        sellTax = _sellTax;
    }
